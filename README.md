...
### 개발일정
![wbs](https://github.com/Nam-Younghoon/For_Your_Date/assets/58909988/332bdae5-d144-41f9-bf86-562e5fc026f2)
...
## 6. 개발 후기
기억상 학부생 때 과제로 나왔던 자기소개 미니홈피 프로젝트 이후로 웹 프로젝트는 처음인 것 같습니다<br>

모바일 프로젝트에서는 코드로 UI를 짜고 빌드해서 스마트폰에 설치된 디버깅 앱을 통해 확인하는데
웹 프로젝트는 저장하고 새로고침만 하면 바로바로 적용되니까 어색했습니다 <br>
물론 플러터에도 핫리로드가 있긴 하지만,, <br>

모바일에서 화면을 그렸던 방식이 아직까지 머리에 습관처럼 남아있다보니 이것저것 많이 헤맸네요<br>
되게 단순하다고 생각했던 프로젝트였는데도 디자인을 먹히는데 한참이나 애를 먹었습니다<br>

특히 기억에 남는 부분을 뽑자면 브라우저에도 sharedpreferences 같이 localStorage가 있다는 새로운 사실을 알게 되어 매우 흥미로웠습니다

웹에서 화면을 어떻게 그리는지, 또 javascript를 통해서 어떻게 이벤트를 제어하는지 기본을 알 수 있었던 재미난 프로젝트였습니다.<br>
